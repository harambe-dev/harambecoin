...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Harambecoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"catillack.com", "45.32.7.193"},
    {"harambepool.com", "104.238.133.44"},
    {"harambecoin.com", "107.191.43.133"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Harambecoin is probably already running."), addrBind.ToString().c_str());
        else
